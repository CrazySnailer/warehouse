...
<table border="0" cellspacing="0" cellpadding="0" class="editTable">
	...
	<tr>
		<td class="right" style="width:15%;">参数分类编码</td>
		<td style="width:35%;">${entity.kindCode}</td>
	</tr>
	<tr>
		<td class="right" style="width:15%;">参数分类名称</td>
		<td style="width:35%;">${entity.kindName}</td>
	</tr>
	<tr>
