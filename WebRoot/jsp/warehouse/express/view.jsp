...
<table border="0" cellspacing="0" cellpadding="0" class="editTable">
		<tr>
		<td class="right viewheader" style="width:20%">物流公司ID</td>
		<td style="width:80%">${entity.expressId}</td>
	</tr>
	<tr>
		<td class="right viewheader" style="width:20%">物流公司名称</td>
		<td style="width:80%">${entity.expressName}</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td style="width:80%">${entity.linkAddress}</td>
	</tr>
	<tr>
